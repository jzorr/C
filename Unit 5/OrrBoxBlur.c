...
//--------------------Start writing to the file------------------------------------------------------------------
    ...
    fwrite(&header.dataOffset, sizeof(int), 1, file);
    
    fwrite(&info.size, sizeof(int), 1, file);
    fwrite(&info.width, sizeof(long), 1, file);
    fwrite(&info.height, sizeof(long), 1, file);
    fwrite(&info.planes, sizeof(int), 1, file);
    fwrite(&info.bitsPerPixel, sizeof(int), 1, file);
    fwrite(&info.compression, sizeof(long), 1, file);
    fwrite(&info.imageSize, sizeof(long), 1, file);
    fwrite(&info.hResolution, sizeof(long), 1, file);
    fwrite(&info.vResolution, sizeof(long), 1, file);
    fwrite(&info.colors, sizeof(int), 1, file);
    fwrite(&info.importantColors, sizeof(int), 1, file);
    
    fwrite(&rgb.red, sizeof(int), 1, file);
    fwrite(&rgb.green, sizeof(int), 1, file);
    fwrite(&rgb.blue, sizeof(int), 1, file);
